...
![[attachments/Image-Based Rendering.png#center|Categories in IBR]]
...
![[attachments/Image-Based Rendering-1.png#center|Representation of a light field]]
...
For a virtual environment, a light slab is easily generated simply by rendering a 2D array of images. Each image represents a slice of the 4D light slab at a fixed uv value and is formed by placing the center of projection of the virtual camera at the sample location on the uv plane. The only issue is that the xy samples of each image must correspond exactly with the st samples. This is easily done by performing a sheared perspective projection ![[attachments/Image-Based Rendering-3.png]] similar to that used to generate a stereo pair of images. The picture below shows the resulting 4D light field, which can be visualized either as a uv array of st images or as an st array of uv images.

![[attachments/Image-Based Rendering-2.png]]
...
![[attachments/Image-Based Rendering-6.png]]
...
![[attachments/Image-Based Rendering-5.png]]
...
![[attachments/Image-Based Rendering-4.png]]
